...
<body>
	...
	<div id="horreur" align="center">
		...
		<?php
			$connexion = new mysqli("localhost", "adminsio", "Siojjr1$", "chouflex")
			or die("connexion impossible");

			$requete1= "select * from serie where genre='Horreur';";
